...
public class SlideOnTop extends BaseEffect {
	...
	protected void setInAnimation(View view) {
		...
		getAnimatorSet().playTogether(ObjectAnimator.ofFloat(view, "translationY", -view.getWidth(), -10, -20, -5, -10, 0).setDuration(mDuration));
	}

	@Override
	protected void setOutAnimation(View view) {
		getAnimatorSet().playTogether(ObjectAnimator.ofFloat(view, "translationY", 0, -10, -5, -view.getWidth()).setDuration(mDuration));
	}
