...
public class ThumbSlider extends BaseEffect {
    ...
    long s = (mDuration - 200) / 2, m = 200, e = (mDuration - 200) / 2;
    ...
    protected void setInAnimation(View view) {
        ...
        if (iconView != null) {
            ...
            getAnimatorSet().playTogether(
                    ...
                    ObjectAnimator.ofFloat(iconView, "scaleX", 0, .5f, 1, .9f, 1, 1.2f, 1).setDuration(s), ObjectAnimator.ofFloat(iconView, "scaleY", 0, .5f, 1, 1.2f, 1, .9f, 1).setDuration(s), msgScaleAnim, msgAlphaAnim
    ...
    protected void setOutAnimation(View view) {
        ...
        if (iconView != null) {
            ...
            getAnimatorSet().playTogether(
                    ...
                    ObjectAnimator.ofFloat(msgView, "scaleX", 1, 1.1f, 1, .5f, 0).setDuration(e), iconScaleXAnim, iconScaleYAnim, iconAlphaAnim
